...
import admin.Category_1;
import admin.ManageProducts;
import admin.Manageoffers;
...
public class Menu extends javax.swing.JPanel {
        ...
        m.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (index != selectedIndex) {
                    ...
                    animator.start();
                    if (menuName.equals("Product")) {
                        // Open the ManageProducts frame
                        openManageProductsFrame();
                    }
                    ...
                    if (menuName.equals("Offer")) {
                        // Open the ManageProducts frame
                        openManageofferFrame();
                    }
                }
            }
        });
    ...
    private void openManageProductsFrame() {
        ManageProducts manageProductsFrame = new ManageProducts();
        manageProductsFrame.setVisible(true);
    }
      private void opencat() throws SQLException {
        Category_1 managecat = new Category_1();
        managecat.setVisible(true);
    }
    
    private void openManageofferFrame() {
        Manageoffers manageoffersFrame = new Manageoffers();
        manageoffersFrame.setVisible(true);
    }
